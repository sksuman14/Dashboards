      ...
      const fetchAllDevices = async () => {
        try {
          ...
          const targetLocations = [
            { City: 'Ropar', State: 'Punjab', lat: 30.9664, lng: 76.5331 },
            { City: 'Chandigarh', State: 'Chandigarh', lat: 30.7289, lng: 76.8028 },
            { City: 'Mohali', State: 'Punjab', lat: 30.6860, lng: 76.7324 }, // Sector 63 Phase 9
            { City: 'Lasalgaon', State: 'Maharashtra', lat: 20.1444, lng: 74.2255 },
            { City: 'Mahuva', State: 'Gujarat', lat: 21.0914, lng: 71.7610 }
          ];
          ...
          const liveDevices: CloudSenseDevice[] = results.map((res, i) => {
            ...
            // Add a slight jitter so markers at the same location don't perfectly overlap
        ...
        {activeTab === 'overview' && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem', maxWidth: '1400px', margin: '0 auto' }}>
            ...
            <div className="glass-card" style={{ padding: '1.5rem', marginBottom: '2rem' }}>
              <h3 style={{ marginBottom: '1rem', fontSize: '1.5rem', color: 'var(--text-primary)' }}>Deployment Map</h3>
              <MapContainer center={[23.5, 78.0]} zoom={4} scrollWheelZoom={true} attributionControl={false} style={{ height: '400px', width: '100%', borderRadius: '1rem', zIndex: 10 }}>
                <TileLayer
                ...
                {devices.map(device => (
                  device.lat && device.lng && (
                    ...
                    >
                      <LeafletTooltip direction="top" offset={[0, -30]} opacity={1}>
